              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  ...
                  <p class="item-company">
                    By <span class="company-name">Google</span>
                  </p>
                </div>
                <div>
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                <div class="item-wrapper">
                  ...
                  <div>
                    <h6 class="item-price">$35.00</h6>
                  </div>
                </div>
                <div class="item-name">
                  <a href="app-ecommerce-details.html"
                    >Google - Chromecast - Black</a
                  >
                  <p class="item-company">
                    By <span class="company-name">Amazon</span>
                  </p>
                </div>
                <div>
                  <p class="item-description">
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                <div class="item-wrapper">
                  ...
                  <div>
                    <div class="item-cost">
                      <h6 class="item-price">$499.99</h6>
                    </div>
                  </div>
                </div>
                <div class="item-name">
                  <a href="app-ecommerce-details.html"
                    >Dell - Inspiron 15.6" Touch-Screen Laptop - Black</a
                  >
                  <p class="item-company">
                    By <span class="company-name">Dell</span>
                  </p>
                </div>
                <div>
                  <p class="item-description">
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  ...
                  <p class="item-company">
                    By <span class="company-name">Apple</span>
                  </p>
                </div>
                <div>
                  <p class="item-description">
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  ...
                  <p class="item-company">
                    By <span class="company-name">Sharp</span>
                  </p>
                </div>
                <div>
                  <p class="item-description">
            ...
            <div class="card-content">
              ...
              <div class="card-body">
                ...
                <div class="item-name">
                  ...
                  <p class="item-company">
                    By <span class="company-name">Philips</span>
                  </p>
                </div>
                <div>
                  <p class="item-description">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="price-slider">
                ...
                <div class="price-slider">
                  <div class="price_slider_amount mb-2"></div>
                  <div class="form-group">
                    <div
                      class="slider-sm my-1 range-slider"
                      id="price-slider"
                    ></div>
                  </div>
                </div>
                ...
                <ul class="list-unstyled categories-list">
                  ...
                  <li>
                    <span class="vs-radio-con vs-radio-primary py-25">
                      ...
                      <span class="ml-50">Video Games </span>
                    </span>
                  </li>
                </ul>
              </div>
